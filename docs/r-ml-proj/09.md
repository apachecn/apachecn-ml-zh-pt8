<title>Winning the Casino Slot Machines with Reinforcement Learning</title>  
...
从结果中，我们可以推断，当回报的波动越大，UCB 算法就越容易陷入次优选择，永远找不到最优的土匪。Thompson 采样通常更加稳健，能够在各种情况下找到最佳的 bandit。
